import { hasInjectionContext, getCurrentInstance as getCurrentInstance$1, version as version$1, inject as inject$1, createVNode, mergeProps, Transition, toRefs, shallowRef, ref, computed, watch, nextTick, toRef, watchEffect, provide, onScopeDispose, withDirectives, resolveDirective, vShow, Fragment, reactive, capitalize, h, onUpdated, defineComponent as defineComponent$1, camelize, unref, toRaw, readonly, TransitionGroup, isRef, Text, resolveDynamicComponent, effectScope, warn, Teleport, cloneVNode, createTextVNode, vModelText, useSSRContext, createApp, onErrorCaptured, onServerPrefetch, isReadonly, defineAsyncComponent, isShallow, isReactive, Suspense } from 'vue';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_id_-66a4c43d.mjs').then((m) => m.default || m)
  },
  {
    name: "areas",
    path: "/areas",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-aa558e88.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-7d75ed79.mjs').then((m) => m.default || m)
  },
  {
    name: "people-id",
    path: "/people/:id()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_id_-4a28668c.mjs').then((m) => m.default || m)
  },
  {
    name: "projects-id",
    path: "/projects/:id()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_id_-9cde2648.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-a8d1f810.mjs').then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-9eba4b2d.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
export { _export_sfc as _, appLayoutTransition as a, _wrapIf as b, useRouter$1 as c, createError as d, entry$1 as default, useNuxtApp as e, useRequestFetch as f, navigateTo as n, useRoute as u };
