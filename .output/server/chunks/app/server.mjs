import { hasInjectionContext, getCurrentInstance as getCurrentInstance$1, inject as inject$1, version as version$1, createVNode, mergeProps, Transition, toRefs, shallowRef, ref, computed, watch, nextTick, toRef, watchEffect, provide, onScopeDispose, withDirectives, resolveDirective, vShow, Fragment, reactive, capitalize, h, onUpdated, defineComponent as defineComponent$1, resolveComponent, camelize, unref, toRaw, readonly, TransitionGroup, isRef, Text, resolveDynamicComponent, effectScope, warn, Teleport, cloneVNode, createTextVNode, vModelText, useSSRContext, createApp, onErrorCaptured, onServerPrefetch, isReadonly, defineAsyncComponent, isShallow, isReactive, withCtx, Suspense } from 'vue';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_id_-0eb4d0c5.mjs').then((m) => m.default || m)
  },
  {
    name: "areas",
    path: "/areas",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-5dd9e41c.mjs').then((m) => m.default || m)
  },
  {
    name: "contact",
    path: "/contact",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-dd9ca423.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-5bb0d4cc.mjs').then((m) => m.default || m)
  },
  {
    name: "people-id",
    path: "/people/:id()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_id_-d20bdf19.mjs').then((m) => m.default || m)
  },
  {
    name: "people",
    path: "/people",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-58369462.mjs').then((m) => m.default || m)
  },
  {
    name: "projects-id",
    path: "/projects/:id()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_id_-1b61e938.mjs').then((m) => m.default || m)
  }
];
...
const __nuxt_component_7 = /* @__PURE__ */ defineNuxtLink({ componentName: "NuxtLink" });
...
const layouts = {
  default: /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/default-ed7b1b37.mjs').then((m) => m.default || m))
};
...
const _sfc_main = {
  ...
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-c64bcb4c.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
export { _export_sfc as _, useRequestFetch as a, useRoute as b, createError as c, __nuxt_component_7 as d, entry$1 as default, useNuxtApp as u };
