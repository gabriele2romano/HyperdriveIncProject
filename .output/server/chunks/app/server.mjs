import { hasInjectionContext, getCurrentInstance as getCurrentInstance$1, version as version$1, createVNode, mergeProps, Transition, toRefs, shallowRef, ref, computed, watch, nextTick, toRef, watchEffect, provide, onScopeDispose, withDirectives, resolveDirective, vShow, Fragment, reactive, inject as inject$1, capitalize, h, onUpdated, defineComponent as defineComponent$1, unref, camelize, toRaw, readonly, TransitionGroup, isRef, Text, resolveDynamicComponent, effectScope, warn, Teleport, cloneVNode, createTextVNode, vModelText, useSSRContext, createApp, onErrorCaptured, onServerPrefetch, isReadonly, defineAsyncComponent, isShallow, isReactive, withCtx, Suspense } from 'vue';
...
const _routes = [
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-ce1e2bc3.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-af7b42ad.mjs').then((m) => m.default || m)
  },
  {
    name: "people-id",
    path: "/people/:id()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_id_-9d7f74f5.mjs').then((m) => m.default || m)
  },
  {
    name: "people",
    path: "/people",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-d57336a2.mjs').then((m) => m.default || m)
  },
  {
    name: "projects-id",
    path: "/projects/:id()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_id_-108c0869.mjs').then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import('./_nuxt/default-d2d5057b.mjs').then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-1b76118c.mjs').then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-effd1839.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
export { _export_sfc as _, __nuxt_component_0 as a, useNuxtApp as b, createError as c, useRequestFetch as d, entry$1 as default, navigateTo as n, useRouter$1 as u };
