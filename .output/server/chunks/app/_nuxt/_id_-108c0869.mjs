import { withAsyncContext, resolveComponent, withCtx, createVNode, toDisplayString, openBlock, createBlock, Fragment, renderList, useSSRContext, mergeProps, createTextVNode } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderList, ssrRenderStyle } from 'vue/server-renderer';
import { u as useDevice } from './useDevice-442c08e9.mjs';
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    useDevice();
    [__temp, __restore] = withAsyncContext(() => useFetch("/api", "$NLv8nVzATR")), __temp = await __temp, __restore();
    const project_areas = [
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)}>`);
      _push(ssrRenderComponent(_component_v_parallax, { src: "/img/bg-projects.jpg" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(_component_v_col, {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div class="text-h2 pt-3 font-weight-bold"${_scopeId4}>${ssrInterpolate(project_title)}</div>`);
                            } else {
                              return [
                                createVNode("div", { class: "text-h2 pt-3 font-weight-bold" }, toDisplayString(project_title))
                              ];
                            }
                          }),
                          _: 1
                            ...
                            if (_push5) {
                              _push5(ssrRenderComponent(_component_v_sheet, {
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<div${_scopeId5}><div class="text-h4"${_scopeId5}>Problem</div><div class="text-body-3 mb-2"${_scopeId5}>${ssrInterpolate(problem)}</div></div>`);
                                  } else {
                                    return [
                                      createVNode("div", null, [
                                        createVNode("div", { class: "text-h4" }, "Problem"),
                                        createVNode("div", { class: "text-body-3 mb-2" }, toDisplayString(problem))
                                      ])
                                    ];
                                  }
                                }),
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(_component_v_sheet, {
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<div${_scopeId5}><div class="text-h4"${_scopeId5}>Solution</div><div class="text-body-3 mb-2"${_scopeId5}>${ssrInterpolate(solution)}</div></div>`);
                                  } else {
                                    return [
                                      createVNode("div", null, [
                                        createVNode("div", { class: "text-h4" }, "Solution"),
                                        createVNode("div", { class: "text-body-3 mb-2" }, toDisplayString(solution))
                                      ])
                                    ];
                                  }
                                }),
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_v_col, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="text-h4"${_scopeId3}>Project Description</div><p class="text-body-2"${_scopeId3}>${ssrInterpolate(project_description)}</p>`);
                        ...
                        _push4(ssrRenderComponent(_component_ProjectInfocard, {
                          country: project_infocard.country,
                          "foundation-year": project_infocard.foundation_year,
                          "funding-date": project_infocard.funding_date
                        }, null, _parent4, _scopeId3));
                      } else {
                        return [
                          createVNode("div", { class: "text-h4" }, "Project Description"),
                          createVNode("p", { class: "text-body-2" }, toDisplayString(project_description)),
          ...
          if (_push2) {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(_component_v_col, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="justify-center align-center flex-wrap text-left pa-2 ma-2 pl-5 font-weight-medium" height="250" width="100%"${_scopeId3}><div class="text-h4 font-weight-medium"${_scopeId3}>${ssrInterpolate(startup_name)}</div><div class="text-body-3 mb-2"${_scopeId3}>${ssrInterpolate(startup_description)}</div></div>`);
                      } else {
                        return [
                          createVNode("div", {
                            ...
                            createVNode("div", { class: "text-h4 font-weight-medium" }, toDisplayString(startup_name)),
                            createVNode("div", { class: "text-body-3 mb-2" }, toDisplayString(startup_description))
                          ])
                        ];
                      }
                    }),
            ...
            _push2(ssrRenderComponent(_component_v_row, { class: "d-flex justify-center" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<!--[-->`);
                  ssrRenderList(project_areas, (area) => {
                    _push3(ssrRenderComponent(_component_v_col, {
                      cols: "12",
                      md: "3",
                      key: area.id
                  ...
                  return [
                    (openBlock(), createBlock(Fragment, null, renderList(project_areas, (area) => {
...
//# sourceMappingURL=_id_-108c0869.mjs.map
