    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_v_container, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_v_row, { class: "d-flex space-between justify-center" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_v_col, { class: "d-flex text-center justify-center" }, {
                  ...
                  return [
                    createVNode(_component_v_col, { class: "d-flex text-center justify-center" }, {
                      default: withCtx(() => [
                        createVNode(_component_v_btn, {
                          class: "text-light text-body-1 bg-dark-blue",
                          variant: "tonal",
            ...
            _push2(ssrRenderComponent(_component_v_container, { fluid: "" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_v_row, { class: "d-flex space-around justify-center" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(_component_v_sheet, {
                          class: "text-body-2 bg-darker-blue",
                          "max-width": "1200"
                        }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                                              ...
                                              if (_push8) {
                                                _push8(ssrRenderComponent(_component_v_container, null, {
                                                  default: withCtx((_8, _push9, _parent9, _scopeId8) => {
                                                    if (_push9) {
                                                      _push9(ssrRenderComponent(_component_v_row, { "align-content": "space-between" }, {
                                                        default: withCtx((_9, _push10, _parent10, _scopeId9) => {
                                                          if (_push10) {
                                                            _push10(ssrRenderComponent(_component_v_col, { cols: "9" }, {
                                                              default: withCtx((_10, _push11, _parent11, _scopeId10) => {
                                                                if (_push11) {
                                                                  _push11(`<div class="text-h3 pa-2"${_scopeId10}>${ssrInterpolate(name)}</div><div class="text-h4 pa-2"${_scopeId10}>${ssrInterpolate(role)}</div>`);
                                                                } else {
                                                                  return [
                                                            ...
                                                            _push10(ssrRenderComponent(_component_v_col, { justify: "end" }, {
                                                              default: withCtx((_10, _push11, _parent11, _scopeId10) => {
                                                                if (_push11) {
                                                                  _push11(`<div class="text-subtitle-2 pa-2"${_scopeId10}>`);
                                                                  _push11(ssrRenderComponent(_component_v_icon, { icon: "mdi-phone" }, null, _parent11, _scopeId10));
                                                                  _push11(` +39 (123) 4567890 </div><div class="text-subtitle-2 pa-2"${_scopeId10}>`);
                                                                  _push11(ssrRenderComponent(_component_v_icon, { icon: "mdi-email" }, null, _parent11, _scopeId10));
                                                                  _push11(` stevekad@mega.inc </div>`);
                                                                } else {
                                                                  return [
                  ...
                  return [
                    createVNode(_component_v_row, { class: "d-flex space-around justify-center" }, {
                      default: withCtx(() => [
                        createVNode(_component_v_sheet, {
                          class: "text-body-2 bg-darker-blue",
                          "max-width": "1200"
            ...
            return [
              createVNode(_component_v_row, { class: "d-flex space-between justify-center" }, {
                default: withCtx(() => [
                  createVNode(_component_v_col, { class: "d-flex text-center justify-center" }, {
                    default: withCtx(() => [
                      createVNode(_component_v_btn, {
...
//# sourceMappingURL=_id_-d20bdf19.mjs.map
